									...
									<div class="row">								  
									  ...
									  <div class="col-sm-7">
										<div class="form-group view_word {{ $errors->has('cosupervisor_id') ? ' has-danger' : '' }}">
											...
											<option value="">-</option>
											@foreach ($supervisors as $supervisor)
												@if($supervisor->id != $prefsupervisor[0]->id && $supervisor->id != $item->assigned_to)
									...
									<div class="row">								  
									  ...
									  <div class="col-sm-7">
										<div class="form-group view_word {{ $errors->has('thesis_examine') ? ' has-danger' : '' }}">
											<select class="selectpicker col-sm-5 pl-0 pr-0" name="thesis_examine[]" id="thesis_examine" data-style="select-with-transition" onchange="funLimitExamineSelection()" multiple title="-" data-size="2" data-placeholder="Select multiple options" data-live-search="true">
											<option value="">-</option>
											@foreach ($supervisors as $supervisor)
												@if($supervisor->id != $prefsupervisor[0]->id && $supervisor->id != $item->assigned_to && $supervisor->id != $item->cosupervisor)
