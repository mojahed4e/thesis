<div class="card-body">	
		...
		@if(count($progressdetails) > 0)
			...
			@if(auth()->user()->role_id == 4)							
				@if($vOthersFound == 0)
					@if($progressdetails[0]->upload_file_status == 0 && $progressdetails[0]->approval_status == 0)
						<div class="row">
							<input type="hidden" name="otherdocumsnts_flag" id="otherdocumsnts_flag" value="0" /> 
							<div class="col-1">&nbsp;</div>
							<div class="col-3 form_chg text-right pt-2">
				...
				@endif
			@endif
			@if($vOthersFound == 0 && (auth()->user()->role_id == 3 || (auth()->user()->role_id == 2 && $item->assigned_to == auth()->user()->id && request()->get('action') == "ac")) && $progressdetails[0]->upload_file_status == 0)
				<div class="row">
					<input type="hidden" name="otherdocumsnts_flag" id="otherdocumsnts_flag" value="0" /> 
					<div class="col-1">&nbsp;</div>
					<div class="col-3 form_chg text-right pt-2">
