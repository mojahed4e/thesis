									...
									<div class="tab-content tab-space">
										<div class="tab-pane active" id="link1">
											...
											<dir class="row">
												<div class="col-md-6">
													<table class="table">    
														...
														<tr>
															<td class="cbold_text">{{ __('Key Words') }}</td>
															<td class="sid_text">
																@php
							                            			$tagSeq = 0;
							                            			$vPreparePaths = route('mythesis.prepare-meeting-minutes', $item->id);
							                            			$vViewPaths = route('mythesis.view-meeting-minutes', $item->id);
							                            		@endphp
																@if(count($itemtags) > 0) 
															...
															<tr>
																...
																@endif									
																	...
																	@elseif($item->assigned_to > 0)
																		{{ __('Awaiting for Supervisor Acceptance') }}
																	@else
																		{{ __('Awaiting for Prefered Supervisor Selection') }}	
																	@endif
																	</td>
															</tr>				
															<tr>
											...
											<div class="row pl-5">
												...
												<div class="sid_text pt-3 pl-5 col-md-10" style=" text-align:justify;">{!! $item->description !!}</div>
											</div>
											<div class="row pl-5">
											...
											@if($item->approval_status == 1)
											<div class="row">
											  <label class="col-sm-3 col-form-label cbold_text">{{ __('Term - I Completion Date') }}</label>
											  <div class="col-sm-3">
												<div class="form-group cht_text pt-2">
											...
											<div class="row">
							                  ...
							                  <label class="col-sm-4 col-form-label cbold_text">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{ __('Meeting  Minutes - 1 Completion Date') }}</label>
							                  <div class="col-sm-2">
							                    <div class="form-group cht_text pt-2">
							                   		{{($timelineinfo[0]->t1_meeting_minutes1 ? \Carbon\Carbon::parse($timelineinfo[0]->t1_meeting_minutes1)->format('d-m-Y') : '')}}
							                    </div>
							                  </div>                                    
							                </div>
											<div class="row">
							                  <div class="col-sm-2">&nbsp;</div>
							                  <label class="col-sm-4 col-form-label cbold_text">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{ __('Meeting  Minutes - 2 Completion Date') }}</label>
							                  <div class="col-sm-2">
							                    <div class="form-group cht_text pt-2">
							                   		{{($timelineinfo[0]->t1_meeting_minutes2 ? \Carbon\Carbon::parse($timelineinfo[0]->t1_meeting_minutes2)->format('d-m-Y') : '')}}
							                    </div>
							                  </div>                                    
							                </div>
							                <div class="row">
							                  <div class="col-sm-2">&nbsp;</div>
							                  <label class="col-sm-4 col-form-label cbold_text">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{ __('Meeting  Minutes - 3 Completion Date') }}</label>
							                  <div class="col-sm-2">
							                    <div class="form-group cht_text pt-2">
							                   		{{($timelineinfo[0]->t1_meeting_minutes3 ? \Carbon\Carbon::parse($timelineinfo[0]->t1_meeting_minutes3)->format('d-m-Y') : '')}}
							                    </div>
							                  </div>                                  
							                </div>
							                <div class="row">
							                  <div class="col-sm-2">&nbsp;</div>                  
							                  <label class="col-sm-4 col-form-label cbold_text">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{ __('Meeting  Minutes - 4 Completion Date') }}</label>
							                  <div class="col-sm-2">
							                    <div class="form-group cht_text pt-2">
							                   		{{($timelineinfo[0]->t1_meeting_minutes4 ? \Carbon\Carbon::parse($timelineinfo[0]->t1_meeting_minutes4)->format('d-m-Y') : '')}}
							                    </div>
							                  </div>                  
							                </div>
							                <div class="row">
							                  <div class="col-sm-2">&nbsp;</div>
							                  <label class="col-sm-4 col-form-label cbold_text">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{ __('Meeting  Minutes - 5 Completion Date') }}</label>
							                  <div class="col-sm-2">
							                    <div class="form-group cht_text pt-2">
							                   		{{($timelineinfo[0]->t1_meeting_minutes5 ? \Carbon\Carbon::parse($timelineinfo[0]->t1_meeting_minutes5)->format('d-m-Y') : '')}}
							                    </div>
							                  </div>                                     
							                </div>
											<div class="row">
											  <label class="col-sm-3 col-form-label cbold_text">{{ __('Term - II Completion Date') }}</label>
											  <div class="col-sm-3">
												<div class="form-group cht_text pt-2">
											...
											<div class="row">
							                  ...
							                  <div class="col-sm-2">
							                    <div class="form-group cht_text pt-2">
							                   		{{($timelineinfo[0]->t2_meeting_minutes1 ? \Carbon\Carbon::parse($timelineinfo[0]->t2_meeting_minutes1)->format('d-m-Y') : '')}}
							                    </div>
							                  </div>                                    
							                </div>
							                <div class="row">
							                  ...
							                  <div class="col-sm-2">
							                   <div class="form-group cht_text pt-2">
							                   		{{($timelineinfo[0]->t2_meeting_minutes2 ? \Carbon\Carbon::parse($timelineinfo[0]->t2_meeting_minutes2)->format('d-m-Y') : '')}}
							                    </div>
							                  </div>                                    
							                </div>
							                <div class="row">
							                  ...
							                  <div class="col-sm-2">
							                    <div class="form-group cht_text pt-2">
							                   		{{($timelineinfo[0]->t2_meeting_minutes3 ? \Carbon\Carbon::parse($timelineinfo[0]->t2_meeting_minutes3)->format('d-m-Y') : '')}}
							                    </div>
							                  </div>                                  
							                </div>
							                <div class="row">
							                  ...
							                  <div class="col-sm-2">
							                    <div class="form-group cht_text pt-2">
							                   		{{($timelineinfo[0]->t2_meeting_minutes4 ? \Carbon\Carbon::parse($timelineinfo[0]->t2_meeting_minutes4)->format('d-m-Y') : '')}}
							                    </div>
							                  </div>                  
							                </div>
							                <div class="row">
							                  ...
							                  <div class="col-sm-1">
							                    <div class="form-group cht_text pt-2">
							                   		{{($timelineinfo[0]->t2_meeting_minutes5 ? \Carbon\Carbon::parse($timelineinfo[0]->t2_meeting_minutes5)->format('d-m-Y') : '')}}
							                    </div>
							                  </div>
											</div>
											@endif
																		...
																		<li class="timeline-inverted">
																			...
																			<div class="reply_clr timeline-panel">	
																				...
																				<div class="timeline-body cht_text" style="max-width:30.9rem; display: inline-block; word-wrap: break-word !important; white-space:initial;">
																					...
																					@else
																						<span style="font-weight:bold;">{{ __('Action:')}}</span>{{__(' Message Posted') }}
																					@endif
...
<script>
  $(document).ready(function() {
	...
	function funPrepareMeetingMinutes(pmTerm,pmSeq) {
		...
		document.frmCommentUpdate.action='{{$vPreparePaths}}';
		document.frmCommentUpdate.method='POST'
		document.frmCommentUpdate.submit();		
	}
	...
	function funViewMeetingMinutes(pmTerm,pmSeq) {		
		...
		$("#term_seq").val(pmTerm);
		$("#viewflag").val(1);
		document.frmCommentUpdate.action='{{$vViewPaths}}';
		document.frmCommentUpdate.method='POST'
		document.frmCommentUpdate.submit();		
	}
