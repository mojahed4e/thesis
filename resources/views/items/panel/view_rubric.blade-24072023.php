@php
if($type == 1){
	$header = array('activePage' => 'track-activity', 'menuParent' => 'laravel', 'titlePage' => __('View Term - '.$term.' Report Rubric '));
	$pagetitle = 'View Term - '.$term.' Report Rubric ';
}
else{
	$header = array('activePage' => 'track-activity', 'menuParent' => 'laravel', 'titlePage' => __('View Term - '.$term.' Presentation Rubric '));
	$pagetitle = 'View Term - '.$term.' Presentation Rubric ';
}
@endphp
