@extends('layouts.app', ['activePage' => 'item-management', 'menuParent' => 'laravel', 'titlePage' => __('Thesis Management')])
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group view_word {{ $errors->has('name') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="name" id="input-name" type="text" placeholder="{{ __('Thesis Title') }}" value="{{ old('name') }}" required="true" aria-required="true"/>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group view_word {{ $errors->has('program_id') ? ' has-danger' : '' }}">
                        ...
                        <option value="{{ $program->id }}" {{ $program->id == old('program_id') ? 'selected' : '' }}>{{ $program->description }}</option>
                        @endforeach
                      </select>
                    ...
                    <div class="form-group view_word  {{ $errors->has('objectives') ? ' has-danger' : '' }}">
                      ...
                      @include('alerts.feedback', ['field' => 'objectives'])
        				...
        				@if(auth()->user()->role_id != 3)
        					...
        					<div class="row">
        					  <label class="col-sm-2 col-form-label form_chg">{{ __('Status') }}</label>
