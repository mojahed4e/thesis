@php
$header = array('activePage' => 'item-management', 'menuParent' => 'laravel', 'titlePage' => __('Thesis Details'));
		  ...
		  <form method="post" enctype="multipart/form-data" action="{{ route('item.allocation', $item) }}" autocomplete="off" class="form-horizontal">
            ...
            <div class="card ">
              ...
              <div class="card-body ">
                ...
                <div class="row">
                  <label class="col-sm-2 col-form-label form_chg">{{ __('Keywords') }}</label>
                  <div class="col-sm-7">				  
          						<div class="card-title" style="padding: 17px 5px 0 0;">
                      @php
                ...
                <div class="row">
                  ...
                  <div class="col-sm-10">          
                    <div class="sid_text pt-4" style=" text-align:justify;">{!! $item->description !!}</div>        
                  </div>
                </div>
                <div class="row">
                  <label class="col-sm-2 col-form-label form_chg">{{ __('Aim') }}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
                  <div class="col-sm-10">          
                    <div class="sid_text pt-4" style=" text-align:justify;">{!! $item->aim !!}</div>        
                  </div>
                </div>
                <div class="row">
                  <label class="col-sm-2 col-form-label form_chg">{{ __('Objectives') }}</label>
                  <div class="col-sm-10">          
                    <div class="sid_text pt-4" style=" text-align:justify;">{!! $item->objectives !!}</div>        
                  </div>
                </div>                                                                 
              </div>
